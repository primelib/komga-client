...
type GetBooksDuplicatesV1Request struct {
...
type GetBooksDuplicatesV1Response struct {
	// Success response
...
func GetBooksDuplicatesV1(client *resty.Client, ctx context.Context, req GetBooksDuplicatesV1Request) (*GetBooksDuplicatesV1Response, error) {
	...
	// send the request
	resp, err := r.Get("/api/v1/books/duplicates")
	if err != nil {
		return nil, err
	}

	return &GetBooksDuplicatesV1Response{

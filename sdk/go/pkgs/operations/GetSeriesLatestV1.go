...
type GetSeriesLatestV1Request struct {
...
type GetSeriesLatestV1Response struct {
	// Success response
...
func GetSeriesLatestV1(client *resty.Client, ctx context.Context, req GetSeriesLatestV1Request) (*GetSeriesLatestV1Response, error) {
	...
	// send the request
	resp, err := r.Get("/api/v1/series/latest")
	if err != nil {
		return nil, err
	}

	return &GetSeriesLatestV1Response{

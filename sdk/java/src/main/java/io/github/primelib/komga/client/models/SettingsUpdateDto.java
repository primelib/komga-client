...
@JsonTypeName("SettingsUpdateDto")
@JsonPropertyOrder({
...
public class SettingsUpdateDto {
    ...
    @JsonProperty("renewRememberMeKey")
    protected Boolean renewRememberMeKey;
    ...
    /**
     * Constructs a validated instance of {@link SettingsUpdateDto}.
     *
     * @param spec the specification to process
     */
    public SettingsUpdateDto(Consumer<SettingsUpdateDto> spec) {
        super();
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link SettingsUpdateDto}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #SettingsUpdateDto(Consumer)} instead.
     ...
     * @param renewRememberMeKey renewRememberMeKey
     * @param thumbnailSize thumbnailSize
     * @param taskPoolSize taskPoolSize
     */
    @ApiStatus.Internal
    public SettingsUpdateDto(Boolean deleteEmptyCollections, Boolean deleteEmptyReadLists, Long rememberMeDurationDays, Boolean renewRememberMeKey, String thumbnailSize, Integer taskPoolSize) {

...
@JsonTypeName("LibraryCreationDto")
@JsonPropertyOrder({
    "name",
    "root",
    "importComicInfoBook",
...
public class LibraryCreationDto {
    ...
    /**
     * Constructs a validated instance of {@link LibraryCreationDto}.
     *
     * @param spec the specification to process
     */
    public LibraryCreationDto(Consumer<LibraryCreationDto> spec) {
        super();
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link LibraryCreationDto}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #LibraryCreationDto(Consumer)} instead.
     * @param name name
     * @param root root
